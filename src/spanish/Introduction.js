    ...
    return (
        <div >
            <div className='IntroductionText'>
                ...
                <p><b>Somos una práctica privada que brinda servicios de salud mental y terapia sexual. <br></br> Encontrar un lugar en el cual uno se sienta con confianza suficiente para contar nuestras historias es indispensable para seguir el camino de la sanación emocional y la transformación.<br></br>Un camino desconocido solo nos es desconocido hasta que estemos listos para explorarlo. Estamos aquí para asistirlo con sus necesidades y juntos trabajar para lograr sus objetivos hacia su bienestar.</b></p>
                </div>
            </div>
